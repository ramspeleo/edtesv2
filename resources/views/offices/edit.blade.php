...
<div class="container-fluid py-4">
    ...
    <div class="mb-4">
        ...
        <small class="gov-subtitle d-block mt-2">
            Update office information, hierarchy assignment, classification,
            and operational status within the organizational structure.
        </small>
    </div>
    ...
    <div class="card gov-card shadow-sm">
        ...
        <div class="card-body">
            ...
            <div class="alert alert-warning border">
                ...
                You are updating an existing office record. Changes will take
            ...
            <form action="{{ route('offices.update', $office) }}"
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <small class="text-muted">
                        Last updated:
                        {{ optional($office->updated_at)->format('F d, Y h:i A') }}
                    </small>
